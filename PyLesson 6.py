...
town_car.show_speed()
 ...
 class Stationery():
    def __init__(self, title='Brand name'):
        self.title = title
...
class Pen(Stationery):
    def draw(self):
        print(f"Запуск отрисовки с помощью {self.title} Pen")

class Pencil(Stationery):
    def draw(self):
        print(f"Запуск отрисовки с помощью {self.title} Pencil")

class Handle(Stationery):
    def draw(self):
        print(f"Запуск отрисовки с помощью {self.title} Handle")
